 ...
 * has it own DOM and global JS context (which may or may not be linked to that of the parent depending
 ...
 *
 * In order to be able to directly address this context for eventing and messaging purposes, it needs a
 ...
 *
 * The fin.Frame namespace represents a way to interact with `iframes` and facilitates discovery of current context
