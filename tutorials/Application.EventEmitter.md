...
* view-created (see {@tutorial View.EventEmitter})
* view-attached (see {@tutorial View.EventEmitter})
* view-shown (see {@tutorial View.EventEmitter})
* view-hidden (see {@tutorial View.EventEmitter})
* view-destroyed (see {@tutorial View.EventEmitter})
